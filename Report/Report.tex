...
\todo[inline]{make a decision about this. or consider it as a non-issue}
...
\todo[inline]{what else does the client send here?  doesn't it need to sign this message somehow to show that it knows about the server's public key?}
